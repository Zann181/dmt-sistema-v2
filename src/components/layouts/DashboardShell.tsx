      ...
      >
        ...
        <div className="p-3.5 border-b border-border flex items-center justify-between font-mono shrink-0">
          ...
          <button 
            ...
            className="hidden md:flex p-1.5 rounded-md hover:bg-muted text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
          ...
          <button 
            onClick={() => setSidebarMobile(false)} 
            className="md:hidden p-1.5 rounded-md hover:bg-muted text-muted-foreground hover:text-foreground transition-colors cursor-pointer"
            title="Cerrar menú"
          >
            <X size={16} />
          </button>
            ...
            <div className="group relative">
              ...
              {collapsed && (
                <div className="absolute left-14 top-0 ml-1 hidden group-hover:flex flex-col bg-sidebar border border-border rounded-md shadow-lg py-1.5 min-w-[160px] z-50 animate-in fade-in slide-in-from-left-2 duration-150">
                  <div className="px-3 py-1 text-xs font-bold text-muted-foreground border-b border-border mb-1">
                    Entrada
                  </div>
        ...
        <div className="p-3 border-t border-border bg-zinc-950/20 font-mono shrink-0">
          {!collapsed ? (
            <div className="space-y-2.5 animate-in fade-in slide-in-from-bottom-2 duration-200">
              ...
              <div className="flex items-center justify-between text-[11px] border-b border-zinc-900 pb-1.5 mb-1">
                <span className="text-zinc-500 font-bold uppercase tracking-wider">Usuario:</span>
              ...
              <div className="space-y-1">
                <div className="text-[9px] font-bold uppercase tracking-wider text-zinc-500">Sucursal Activa</div>
              ...
              {/* Event switcher row */}
              <div className="space-y-1">
                <div className="text-[9px] font-bold uppercase tracking-wider text-zinc-500">Evento Activo</div>
                <div className="scale-95 origin-left">
                  <EventSwitcher />
                </div>
              </div>
