            ...
            <button
              ...
              className={`px-4 py-2 text-xs font-bold rounded-lg transition-all ${
                activeTab === "combined"
                  ...
                  : "text-emerald-500 hover:text-zinc-800 dark:hover:text-zinc-200"
              }`}
            >
              Vista General
            </button>
        ...
        <div className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-zinc-50 dark:bg-zinc-900/40 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800/50">
                  <span className="text-xs text-emerald-500 block font-semibold">Total Asistentes</span>
                  <span className="text-xl font-extrabold text-zinc-800 dark:text-zinc-200 font-mono mt-1 block">
                    {entrance?.attendeeCount}
                  </span>
                </div>
                <div className="bg-zinc-50 dark:bg-zinc-900/40 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800/50">
                  <span className="text-xs text-emerald-500 block font-semibold">Check-ins Completados</span>
                  <span className="text-xl font-extrabold text-zinc-800 dark:text-zinc-200 font-mono mt-1 block">
            ...
            <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-zinc-50 dark:bg-zinc-900/40 p-4 rounded-xl border border-zinc-100 dark:border-zinc-800/50">
                  <span className="text-xs text-emerald-500 block font-semibold">Ventas Registradas</span>
                  <span className="text-xl font-extrabold text-zinc-800 dark:text-zinc-200 font-mono mt-1 block">
          ...
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 space-y-4">
            ...
            <div className="flex flex-col md:flex-row items-center gap-8 justify-around py-4">
              <div className="text-center space-y-2">
                <span className="text-sm font-semibold text-emerald-500 block">Total de Boletas Emitidas</span>
                <span className="text-5xl font-black text-zinc-800 dark:text-white font-mono block">
                  {entrance?.attendeeCount}
                </span>
                <span className="text-xs text-emerald-500">Asistentes registrados en base de datos</span>
              </div>
              
              <div className="h-28 w-px bg-zinc-200 dark:bg-zinc-800 hidden md:block" />

              <div className="text-center space-y-2">
                <span className="text-sm font-semibold text-emerald-500 block">Porcentaje de Ingreso</span>
                <span className="text-5xl font-black text-emerald-600 dark:text-emerald-500 font-mono block">
            ...
            <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl p-6 lg:col-span-3 space-y-4">
              ...
              <div className="divide-y divide-zinc-100 dark:divide-zinc-900">
                ...
                {(!bar?.topProducts || bar.topProducts.length === 0) && (
                  <div className="text-center py-12 text-emerald-500 text-xs font-semibold">
