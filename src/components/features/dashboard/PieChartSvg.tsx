...
export function PieChartSvg({ data, size = 160 }: PieChartSvgProps) {
  ...
  if (total === 0) {
    return (
      <div className="flex items-center justify-center text-emerald-500 text-xs font-semibold py-8 border border-dashed border-zinc-200 dark:border-zinc-800 rounded-xl">
