    ...
    <div className="space-y-6">
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-zinc-500">Administra los productos globales de esta sucursal.</p>
        </div>
        <button
          onClick={() => {
            setErrorMsg("")
      ...
      <div className="flex items-center gap-2 bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-lg px-3 py-2 w-full max-w-md shadow-sm">
        ...
        <input
          ...
          className="bg-transparent border-0 outline-none w-full text-sm placeholder:text-zinc-400"
        />
      </div>
      ...
      <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm overflow-hidden">
        <div className="overflow-x-auto">
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="border-b border-zinc-200 dark:border-zinc-800 bg-zinc-50/50 dark:bg-zinc-950/20 text-zinc-500 text-xs font-bold uppercase tracking-wider">
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-2">
                      <button
                        ...
                        className="p-1.5 text-zinc-400 hover:text-indigo-600 dark:hover:text-indigo-400 hover:bg-zinc-100 dark:hover:bg-zinc-800 rounded transition-colors"
                        title="Editar"
                      >
                        <Edit2 size={16} />
                      </button>
        ...
        <div className="fixed inset-0 bg-black/55 flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-md shadow-2xl space-y-4">
            ...
            >
              ...
              <div>
                <label className="text-xs font-semibold text-zinc-500 block mb-1">Precio Base</label>
                <input
                  type="text"
                  placeholder="0"
                  value={form.price}
