    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-zinc-500">Gestiona los eventos, accesos y configuraciones.</p>
        </div>
        <button
          onClick={() => {
            setErrorMsg("")
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredEvents.map((event) => (
          ...
          >
            ...
            <p className="text-sm text-zinc-500 mt-1">Sucursal: {event.branch?.name}</p>
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-md shadow-xl max-h-[90vh] overflow-y-auto space-y-4">
            ...
            >
              ...
              <div>
                <label className="text-xs font-semibold text-zinc-500 block mb-1">Nombre del Evento</label>
                <input
                  type="text"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold text-zinc-500 block mb-1">Inicia</label>
                  <input
                    type="datetime-local"
                ...
                <div>
                  <label className="text-xs font-semibold text-zinc-500 block mb-1">Termina</label>
                  <input
                    type="datetime-local"
              ...
              {showAdvancedCreate && (
                <div className="space-y-4 pt-2 border-t border-zinc-100 dark:border-zinc-800/80 max-h-[35vh] overflow-y-auto pr-1">
                  ...
                  <div className="space-y-3">
                    ...
                    <div>
                      <label className="text-xs text-zinc-500 block mb-1">Nombre del Lugar (Venue)</label>
                      <input
                        type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Dress Code</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Etiqueta de Mapa</label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="text-xs text-zinc-500 block mb-1">Google Maps URL</label>
                      <input
                        type="text"
                  ...
                  <div className="border-t pt-3 border-zinc-100 dark:border-zinc-800 space-y-3">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Servidor de Correo (SMTP)</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Servidor SMTP</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Puerto</label>
                        <input
                          type="number"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Usuario SMTP (Correo)</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Contraseña (App Password)</label>
                        <input
                          type="password"
                    ...
                    <div>
                      <label className="text-xs text-zinc-500 block mb-1">Remitente Personalizado (From)</label>
                      <input
                        type="text"
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      ...
                      />
                      <label htmlFor="createEmailSecureCheckbox" className="text-xs text-zinc-500 select-none">
                  ...
                  {/* Contenido Plantilla */}
                  <div className="border-t pt-3 border-zinc-100 dark:border-zinc-800 space-y-3">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Plantilla del Email</p>
                    <div>
                      <label className="text-xs text-zinc-500 block mb-1">Asunto del Correo</label>
                      <input
                        type="text"
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Preheader</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Título Mensaje (Heading)</label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="text-xs text-zinc-500 block mb-1">Cuerpo del Correo</label>
                      <textarea
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Título de Advertencia</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Firma de Equipo</label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="text-xs text-zinc-500 block mb-1">Texto de Advertencia</label>
                      <textarea
             ...
             >
              ...
              {activeConfigTab === "general" && (
                <div className="space-y-4">
                  ...
                  <div>
                    <label className="text-xs font-semibold text-zinc-500 block mb-1">Estado</label>
                    <select
              ...
              {activeConfigTab === "qr" && (
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Prefijo de Código QR</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Escala del Logo en QR</label>
                      <select
                  ...
                  <div className="grid grid-cols-3 gap-3 border-t pt-3 border-zinc-100 dark:border-zinc-800">
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Color Relleno QR</label>
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Color Fondo QR</label>
                      <div className="flex gap-1.5">
                        <input
                          type="color"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Fondo Logo en QR</label>
                      <div className="flex gap-1.5">
                        <input
                          type="color"
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-2 gap-3">
                    <div className="col-span-2">
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Nombre del Lugar / Local</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Código de Vestimenta (Dress code)</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Políticas de Acceso</label>
                      <input
                        type="text"
                  ...
                  <div className="grid grid-cols-2 gap-3 border-t pt-3 border-zinc-100 dark:border-zinc-800">
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">URL Google Maps</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Etiqueta de Mapa</label>
                      <input
                        type="text"
              ...
              {activeConfigTab === "email" && (
                <div className="space-y-4 max-h-[50vh] overflow-y-auto pr-1">
                  <div>
                    <label className="text-xs font-semibold text-zinc-500 block mb-1">Asunto del Correo</label>
                    <input
                      type="text"
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Pre-encabezado (Preheader)</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Título del Mensaje (Heading)</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-zinc-500 block mb-1">Mensaje Introductorio</label>
                    <textarea
                  ...
                  <div className="border-t pt-3 border-zinc-100 dark:border-zinc-800 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3 items-end">
                      <div>
                        <label className="text-xs font-semibold text-zinc-500 block mb-1">Tamaño del Logo en Email</label>
                  ...
                  <div className="border-t pt-3 border-zinc-100 dark:border-zinc-800 space-y-3">
                    <p className="text-xs font-bold text-zinc-400 uppercase tracking-wider">Diseño y Colores de Plantilla</p>
                    <div className="grid grid-cols-2 gap-3">
                      <div>
                        <label className="text-xs text-zinc-500">Fondo General</label>
                        <div className="flex gap-1.5">
                          <input
                            type="color"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500">Fondo Tarjeta (Card)</label>
                        <div className="flex gap-1.5">
                          <input
                            type="color"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500">Cabecera de Tarjeta</label>
                        <div className="flex gap-1.5">
                          <input
                            type="color"
                      ...
                      <div>
                        <label className="text-xs text-zinc-500">Color de Acento</label>
                        <div className="flex gap-1.5">
                          <input
                            type="color"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-zinc-500 block mb-1">Cuerpo del Correo</label>
                    <textarea
                  ...
                  <div className="grid grid-cols-2 gap-3 border-t pt-3 border-zinc-100 dark:border-zinc-800">
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Título de Advertencia</label>
                      <input
                        type="text"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-zinc-500 block mb-1">Firma de Equipo</label>
                      <input
                        type="text"
                  ...
                  <div>
                    <label className="text-xs font-semibold text-zinc-500 block mb-1">Texto de Advertencia</label>
                    <textarea
                  ...
                  <div className="border-t pt-3 border-zinc-100 dark:border-zinc-800 space-y-3">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="text-xs text-zinc-500 block mb-1">Contraseña (o App Password)</label>
                        <input
                          type="password"
                    ...
                    <div className="flex items-center gap-2 pt-1">
                      <input
                        ...
                        className="rounded border-zinc-300 dark:border-zinc-700 text-indigo-600 focus:ring-indigo-500"
                      />
                      <label htmlFor="emailSecureCheckbox" className="text-xs text-zinc-500 select-none">
                   ...
                   <div className="flex flex-col items-center justify-center p-6 bg-zinc-50 dark:bg-zinc-900/50 rounded-xl border border-zinc-200 dark:border-zinc-800/80 sticky top-0 min-h-[350px]">
                     ...
                     {activeConfigTab === "email" && (
                       <div className="w-full flex flex-col space-y-3">
                         <h4 className="text-sm font-bold text-zinc-500 uppercase tracking-wider text-center">Vista Previa Plantilla Email</h4>
