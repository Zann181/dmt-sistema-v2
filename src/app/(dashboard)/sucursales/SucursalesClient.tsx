...
export function SucursalesClient({ initialBranches }: { initialBranches: Branch[] }) {
  ...
  const renderSvgLogo = (logoStr: string | null) => {
    if (!logoStr) {
      return <Building2 className="text-zinc-600 dark:text-emerald-500 w-6 h-6" />
    }
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {branches.map((branch) => (
          ...
          >
            ...
            <p className="text-sm text-emerald-500 font-mono mt-1">Prefix: {branch.codePrefix}</p>

            {/* Colors Preview */}
            <div className="mt-4 flex items-center gap-2">
              <span className="text-xs text-emerald-500">Colores:</span>
              <div
            ...
            <div className="mt-6 flex flex-col-reverse sm:flex-row gap-3 mt-auto pt-4 border-t border-zinc-100 dark:border-zinc-800">
              ...
              <Link
                ...
                className="text-sm text-zinc-600 dark:text-emerald-500 font-medium hover:underline"
              >
                Staff
              </Link>
              <button
        ...
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-lg shadow-xl max-h-[90vh] overflow-y-auto space-y-4">
            ...
            {editTab === "branding" ? (
              ...
              >
                <div>
                  <label className="text-xs font-semibold text-emerald-500 block mb-1">
              ...
              <div className="space-y-4 animate-in fade-in duration-200">
                {!showCatForm ? (
                  <div className="space-y-4">
                    ...
                    {loadingCategories ? (
                      <div className="text-center py-6 text-emerald-500 text-sm">Cargando categorías...</div>
                    ) : (
                            ...
                            <div key={cat.id} className="p-3 flex items-center justify-between hover:bg-zinc-50 dark:hover:bg-zinc-900/40 transition-colors">
                              ...
                              <div className="flex items-center gap-2">
                                <button
                                  ...
                                  className="p-1 text-emerald-500 hover:text-indigo-600 dark:hover:text-indigo-400 rounded"
                                  title="Editar"
                                >
                                  <Edit2 size={14} />
                                </button>
                                <button
                                  ...
                                  className="p-1 text-emerald-500 hover:text-red-600 dark:hover:text-red-400 rounded"
                                  title="Desactivar"
                                >
                                  <Trash2 size={14} />
                                </button>
                  ...
                  <form onSubmit={handleSaveCategory} className="border border-zinc-200 dark:border-zinc-800 p-4 rounded-xl space-y-4 bg-zinc-50/50 dark:bg-zinc-900/20">
                    ...
                    <div className="grid grid-cols-2 gap-3">
                      ...
                      <div>
                        <label className="text-xs font-semibold text-emerald-500 block mb-1">Precio de Entrada</label>
                        <input
                          type="text"
                          placeholder="0"
                          value={catForm.price}
                      ...
                      <div>
                        <label className="text-xs font-semibold text-emerald-500 block mb-1">Bebidas Incluidas (Consumos)</label>
                        <input
                          type="number"
                          min="0"
                          placeholder="0"
                    ...
                    <div>
                      <label className="text-xs font-semibold text-emerald-500 block mb-1">Descripción corta (Opcional)</label>
                      <input
                        type="text"
