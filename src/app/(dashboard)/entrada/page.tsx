      ...
      <div className="fixed inset-0 bg-black z-[9999] flex flex-col items-center justify-center p-4 animate-in fade-in duration-200 select-none">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 min-w-0 text-white">
                ...
                {notification.subMessage && (
                  <p className="text-xs text-lime-300 mt-0.5 whitespace-pre-wrap">{notification.subMessage}</p>
                )}
              </div>
              <button 
                onClick={() => setNotification(null)}
                className="text-lime-400 hover:text-zinc-350 transition-colors"
              >
                <X size={16} />
              </button>
            </div>
        ...
        <div className="w-full max-w-md flex flex-col items-center space-y-6">
          <div className="text-center space-y-1 w-full">
            ...
            <p className="text-xs text-lime-300">{activeEventName}</p>
          </div>
          ...
          <div className="flex items-center justify-end w-full px-2 text-lime-300 text-xs">
          ...
          {isScanning ? (
            <p className="text-xs text-lime-400 flex items-center justify-center gap-1.5">
          ...
          <button
            ...
            className="text-xs text-lime-300 hover:text-white border border-zinc-800 hover:bg-zinc-900 px-4 py-2 rounded-lg transition-colors mt-4"
          >
            Cerrar Escáner
          </button>
        </div>
              ...
              <div className="bg-zinc-900/80 border border-zinc-800 rounded-lg p-3 text-left space-y-2 text-xs">
                ...
                {alreadyCheckedInInfo.checkedInByName && (
                  <div className="flex justify-between border-t border-zinc-800/60 pt-1.5 mt-1.5">
                    <span className="text-lime-400">Escaneado por:</span>
    ...
    <div className="space-y-6 relative">
        ...
        >
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0">
              ...
              {notification.subMessage && (
                <p className="text-xs text-lime-400 dark:text-lime-300 mt-0.5 whitespace-pre-wrap">{notification.subMessage}</p>
              )}
            </div>
            <button 
              onClick={() => setNotification(null)}
              className="text-lime-300 hover:text-zinc-650 dark:hover:text-zinc-200 transition-colors"
            >
              <X size={16} />
            </button>
          </div>
      ...
      <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-lime-400 text-sm hidden sm:block">Control de acceso y escáner QR.</p>
        </div>
        ...
        <button
          ...
          className={`flex-1 py-2.5 text-xs font-bold rounded-lg transition-all flex items-center justify-center gap-2 ${
            activeTab === "search"
              ...
              : "text-lime-400 hover:text-zinc-700 dark:hover:text-zinc-300"
          }`}
        >
        ...
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm overflow-hidden flex flex-col h-[600px] animate-in fade-in duration-200">
          <form onSubmit={handleSearch} className="p-4 border-b border-zinc-200 dark:border-zinc-800 flex items-center gap-4">
            <div className="relative flex-1">
              <Search className="absolute left-3 top-1/2 -translate-y-1/2 text-lime-300" size={18} />
              <input 
                type="text" 
          ...
          <div className="flex-1 overflow-y-auto p-0">
            <table className="w-full text-sm text-left">
              <thead className="bg-zinc-50 dark:bg-zinc-900/50 sticky top-0 border-b border-zinc-200 dark:border-zinc-800">
                <tr>
                  <th className="px-6 py-3 font-medium text-lime-400">Asistente</th>
                  <th className="px-6 py-3 font-medium text-lime-400">Cédula</th>
                  <th className="px-6 py-3 font-medium text-lime-400">Categoría</th>
                  <th className="px-6 py-3 font-medium text-lime-400 text-right">Estado / Acciones</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-zinc-200 dark:divide-zinc-800">
                {isLoading ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-8 text-center text-lime-400">Cargando asistentes...</td>
                  </tr>
                ) : attendees?.length === 0 ? (
                  <tr>
                    <td colSpan={4} className="px-6 py-8 text-center text-lime-400">No hay asistentes registrados para este evento.</td>
                  </tr>
                ) : (
                  attendees?.map((a) => (
                    <tr key={a.id} className="hover:bg-zinc-50 dark:hover:bg-zinc-900/50 transition-colors">
                      ...
                      <td className="px-6 py-3 text-lime-400">{a.cc}</td>
                      <td className="px-6 py-3 text-lime-400">
                          ...
                          <div className="flex items-center gap-1.5">
                            {a.phone && (
                              <button
                                ...
                                className="p-1 text-lime-300 hover:text-green-500 dark:hover:text-green-400 transition-colors"
                            ...
                            {a.email && (
                              <button
                                ...
                                className="p-1 text-lime-300 hover:text-indigo-650 dark:hover:text-indigo-400 transition-colors disabled:opacity-50"
                            ...
                            <button
                              ...
                              className="p-1 text-lime-300 hover:text-indigo-650 dark:hover:text-indigo-400 transition-colors"
                              title="Editar"
                            >
                              <Edit size={14} />
                            </button>
                            <button
                              ...
                              className="p-1 text-lime-300 hover:text-red-650 dark:hover:text-red-400 transition-colors"
                              title="Eliminar"
                            >
                              <Trash2 size={14} />
                            </button>
      ...
      {activeTab === "add" && (
        <div className="bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 rounded-xl shadow-sm overflow-hidden p-6 max-w-xl mx-auto animate-in fade-in duration-200 space-y-4">
          <div className="border-b pb-3 border-zinc-200 dark:border-zinc-800">
            ...
            <p className="text-xs text-lime-400 mt-1">Registra de forma manual un asistente al evento actual.</p>
          </div>
          ...
          >
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-semibold text-lime-400 block mb-1">Nombre Completo *</label>
                <input
                  type="text"
              ...
              <div>
                <label className="text-xs font-semibold text-lime-400 block mb-1">Cédula / Documento *</label>
                <input
                  type="text"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <label className="text-xs font-semibold text-lime-400 block mb-1">Celular (Opcional)</label>
                <input
                  type="tel"
              ...
              <div>
                <label className="text-xs font-semibold text-lime-400 block mb-1">Correo (Opcional)</label>
                <input
                  type="email"
            ...
            <div className="grid grid-cols-2 gap-4">
              <div>
                <div className="flex items-center justify-between mb-1">
                  <label className="text-xs font-semibold text-lime-400 block">Categoría *</label>
                    ...
                    <div className="flex items-center gap-2">
                      {addForm.categoryId && (
                        <button
                          ...
                          className="text-lime-300 hover:text-white p-1 rounded hover:bg-zinc-800 transition-colors cursor-pointer"
              ...
              <div>
                <label className="text-xs font-semibold text-lime-400 block mb-1">Monto Pagado ($) *</label>
                <input
                  type="text"
                  placeholder="0"
      ...
      {activeTab === "dashboard" && (
        <div className="space-y-6 animate-in fade-in duration-200">
          {isStatsLoading ? (
            ...
            <div className="text-center py-12 text-lime-400 text-sm">
            ...
            <>
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4 font-mono">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 shadow-lg relative overflow-hidden group">
                  <div className="absolute top-0 right-0 p-3 opacity-10 group-hover:scale-110 transition-transform text-lime-400">
                    <Banknote size={48} />
                  </div>
                  <p className="text-[10px] text-lime-300 uppercase font-bold tracking-wider">Ingreso Total</p>
                  <p className="text-2xl font-black text-lime-400 mt-1">
                    ${formatThousands(stats.totalIncome.toString())}
                  </p>
                  <p className="text-[9px] text-lime-400 mt-2 font-sans">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 shadow-lg relative overflow-hidden group">
                  ...
                  <p className="text-[10px] text-lime-300 uppercase font-bold tracking-wider">Ingreso de Hoy</p>
                  <p className="text-2xl font-black text-indigo-400 mt-1">
                    ${formatThousands(stats.todayIncome.toString())}
                  </p>
                  <p className="text-[9px] text-lime-400 mt-2 font-sans flex items-center gap-1.5">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 shadow-lg relative overflow-hidden group">
                  ...
                  <p className="text-[10px] text-lime-300 uppercase font-bold tracking-wider">Total Registrados</p>
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-4 shadow-lg relative overflow-hidden group">
                  ...
                  <p className="text-[10px] text-lime-300 uppercase font-bold tracking-wider">Ingresados / Faltan</p>
                  <div className="flex items-baseline gap-2 mt-1">
                    ...
                    <span className="text-lime-300 text-sm font-bold">{stats.pendingCount} pendientes</span>
                  </div>
              ...
              <div className="bg-zinc-900 border border-zinc-800 rounded-xl shadow-lg overflow-hidden flex flex-col font-mono">
                <div className="p-4 border-b border-zinc-800 bg-zinc-950 flex items-center justify-between">
                  ...
                  <span className="text-[10px] text-lime-400">Actualizado en tiempo real</span>
                </div>
                
                <div className="overflow-x-auto">
                  <table className="w-full border-collapse text-xs text-left">
                    <thead>
                      <tr className="bg-zinc-950/50 text-lime-300 border-b border-zinc-800">
                    ...
                    <tbody className="divide-y divide-zinc-800/60">
                      {stats.categoryStats?.map((cat: any) => {
                        ...
                        return (
                          <tr key={cat.id} className="hover:bg-zinc-800/30 transition-colors border-b border-zinc-800/40">
                            ...
                            <td className="p-4 text-center text-lime-300 font-bold">{cat.pending}</td>
                            ...
                            <td className="p-4 text-right font-black text-lime-400 text-sm">
                      ...
                      {stats.categoryStats?.length === 0 && (
                        <tr>
                          <td colSpan={7} className="p-8 text-center text-lime-400 italic">
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-50 animate-in fade-in duration-200">
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-md shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b pb-3 border-zinc-200 dark:border-zinc-800">
              ...
              <button onClick={() => setShowCashModal(false)} className="text-lime-300 hover:text-zinc-655 dark:hover:text-zinc-200">
                <X size={18} />
              </button>
            </div>
        ...
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center p-4 z-[60] animate-in fade-in duration-200">
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-md shadow-2xl space-y-4">
            <div className="flex items-center justify-between border-b pb-3 border-zinc-200 dark:border-zinc-800">
              ...
              <button onClick={() => setEditingAttendee(null)} className="text-lime-300 hover:text-zinc-650 dark:hover:text-zinc-200">
                <X size={18} />
              </button>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold text-lime-400 block mb-1">Celular</label>
                  <input
                    type="text"
                ...
                <div>
                  <label className="text-xs font-semibold text-lime-400 block mb-1">Correo</label>
                  <input
                    type="email"
          ...
          <div className="bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-xl p-6 w-full max-w-md shadow-2xl space-y-4 font-mono">
            <div className="flex items-center justify-between border-b pb-3 border-zinc-200 dark:border-zinc-800">
              ...
              <button 
                ...
                className="text-lime-300 hover:text-zinc-650 dark:hover:text-zinc-200 cursor-pointer"
              >
                <X size={18} />
              </button>
            </div>
            ...
            >
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="text-xs font-semibold text-lime-400 block mb-1">Precio ($) *</label>
                  <input
                    type="text"
                    placeholder="0"
                ...
                <div>
                  <label className="text-xs font-semibold text-lime-400 block mb-1">Consumos Incluidos</label>
                  <input
                    type="number"
                    min="0"
              ...
              <div>
                <label className="text-xs font-semibold text-lime-400 block mb-1">Descripción (Opcional)</label>
                <textarea
                  rows={2}
              ...
              <div className="flex gap-3 justify-end border-t pt-4 border-zinc-200 dark:border-zinc-800">
                <button
                  ...
                  className="px-4 py-2 border border-zinc-800 rounded-md text-xs font-bold uppercase tracking-wider text-lime-300 hover:bg-zinc-900 transition-colors cursor-pointer"
                >
                  Cancelar
                </button>
                <button
